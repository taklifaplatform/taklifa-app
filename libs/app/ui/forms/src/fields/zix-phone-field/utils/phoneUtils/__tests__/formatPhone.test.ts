...
describe('formatPhone', () => {
  ...
  test('should trim provided value by mask', () => {
    expect(formatPhone('+380123456789012345678', defaultConfig)).toBe('+380 (12) 345 67 89')
  })
  ...
  test('should apply mask if provided phone of another country', () => {
    expect(formatPhone('+1 (234) 567-8900', defaultConfig)).toBe('+123 (45) 678 90 0')
  ...
  test('should support different charAfterDialCode', () => {
    expect(formatPhone('+380123456789', { ...defaultConfig, charAfterDialCode: '' })).toBe(
      '+380(12) 345 67 89'
    )
  ...
  test('should insert dial_code in the result value if forceDialCode is true', () => {
    const config = {
      ...defaultConfig,
      dial_code: '499',
      mask: '(...) ... ... ...',
