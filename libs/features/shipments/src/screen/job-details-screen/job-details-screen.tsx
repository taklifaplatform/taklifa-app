      ...
      <ZixWidgetContainer label={t('shipment:shipment-details')}>
        <YStack gap="$6" marginTop="$4">
          <ZixVariantOptionsWidget
            ...
            options={[
              {
                icons: <Package size="$1" color={'$color1'} />,
                name: t('job:number-of-packages'),
                value: `${job?.items?.length}`,
              },
              {
                icons: <PackageOpen size="$1" color={'$color1'} />,
              ...
              {
                icons: <Weight size="$1" color={'$color1'} />,
          ...
          <ZixVariantOptionsWidget
            ...
            options={[
              {
                icons: <Inbox size="$1" color={'$color1'} />,
                name: t('job:deliver_duration'),
                value: `${deliveryTime.humanize()}`,
              },
              {
                icons: <Route size="$1" color={'$color1'} rotate="90deg" />,
                name: t('job:estimated-distance'),
                value: `${distance} km`,
              },
              {
                icons: <CustomIcon name="chronic" size="$1" color={'$color1'} />,
                name: t('job:estimated-time'),
                value: `${duration.asMinutes()}`,
              },
              {
                icons: <CustomIcon name="time" size="$1" color={'$color1'} />,
                name: t('job:deliver_time'),
                value: `${job?.pick_time}`,
              },
              {
                icons: <CalendarDays size="$1" color={'$color1'} />,
