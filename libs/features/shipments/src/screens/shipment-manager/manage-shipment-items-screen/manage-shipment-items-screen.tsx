...
const SendFromSchema = z.object({
  ...
  items: z.array(z.object({
    ...
    dim_height: formFields.text.describe('Height // Enter the height of the item'),
    dim_width: formFields.text.describe('Width // Enter the width of the item'),
    dim_length: formFields.text.describe('Length // Enter the length of the item'),

    content: formFields.text.describe('Content // Enter the content of the item'),
