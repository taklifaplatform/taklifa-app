...
const LoginSchema = z.object({
  ...
  boolean_checkbox: formFields.accept_terms.describe(
    'الموافقة على الشروط والأحكام الخاصة بسواعد',
  ),
        ...
        {(fields) => (
          <>
            ...
            >
              ...
              >
                {' '}
                لقد تمت دعوتك للانضمام إلى InstaPack، يرجى تسجيل الدخول/التسجيل
                لقبول الدعوة
              </Text>
            </YStack>
