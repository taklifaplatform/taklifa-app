    ...
    <>
      ...
      <ScrollView flex={1}>
        <YStack gap="$4" padding="$4" alignItems="flex-start">
          ...
          <RenderTitle>الشروط والأحكام – تطبيق تكلفة</RenderTitle>
          <RenderTextContent>
            يرجى قراءة الشروط التالية بعناية قبل استخدام تطبيق "تكلفة". باستخدامك للتطبيق، فإنك تُقر بقبولك الكامل لجميع الشروط والأحكام التالية:
          </RenderTextContent>

          <RenderSemiTitle>طبيعة الخدمة</RenderSemiTitle>
          <RenderTextContent>
            تطبيق تكلفة يعمل كوسيط إلكتروني بين طالب الخدمة (العميل) ومقدم الخدمة (السائق أو الناقل)، ولا يقدم خدمات النقل بنفسه.
          </RenderTextContent>

          <RenderSemiTitle>حدود المسؤولية</RenderSemiTitle>
          <RenderTextContent>
            لا يتحمل تطبيق تكلفة أي مسؤولية مباشرة أو غير مباشرة عن أي تلف، فقدان، أو سرقة للممتلكات المنقولة. يتحمل مقدم الخدمة كامل المسؤولية القانونية والمالية تجاه العميل عن أي ضرر ناتج عن الخدمة.
          </RenderTextContent>
          ...
          <RenderTextContent>
            يحق لإدارة تطبيق تكلفة تعديل هذه الشروط في أي وقت، وسيتم إشعار المستخدمين بأي تغييرات عند الدخول إلى التطبيق.
          </RenderTextContent>
        </YStack>
      </ScrollView>
    </>
