    ...
    <>
      ...
      <ScrollView paddingTop="$6">
        ...
        <YStack gap="$4" padding="$4">
          ...
          <RenderTitle>سياسة الخصوصية – تطبيق سواعد</RenderTitle>
          <RenderTextContent>
            نحن في تطبيق "سواعد" نُولي أهمية قصوى لخصوصية مستخدمينا ونسعى جاهدين لحماية جميع البيانات الشخصية التي يتم جمعها عبر التطبيق. باستخدامك لتطبيق سواعد، فإنك توافق على جمع واستخدام معلوماتك وفقًا لما هو موضح في هذه السياسة.
          </RenderTextContent>
