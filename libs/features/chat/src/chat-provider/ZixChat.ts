...
import { ExtendableGenerics, DefaultGenerics, StreamChatOptions } from 'stream-chat/src/types';
...
export class ZixChat<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics> extends StreamChat {
  ...
  public static getInstance<StreamChatGenerics extends ExtendableGenerics = DefaultGenerics>(
    ...
    if (!StreamChat._instance) {
      if (typeof secretOrOptions === 'string') {
        ZixChat._instance = new ZixChat<StreamChatGenerics>(key, secretOrOptions, options);
      } else {
        ZixChat._instance = new ZixChat<StreamChatGenerics>(key, secretOrOptions);
      }
    }
