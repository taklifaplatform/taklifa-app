...
import { Avatar, Spinner, useTheme, useViewport } from 'stream-chat-expo';
...
export const MessageSearchList: React.FC<MessageSearchListProps> =
  React.forwardRef(
    (
      props,
      scrollRef: React.Ref<FlatList<MessageResponse<StreamChatGenerics>> | null>
    ) => {
      const {
      ...
      return (
        <>
          ...
          <FlatList
            ...
            data={
              messages ? messages.filter(({ parent_id }) => !parent_id) : []
            }
                  ...
                  <View style={styles.row}>
                    <Text
                      ...
                      style={[
                        ...
                        { color: black, maxWidth: vw(80) - 16 - 40 }
                      ]}
                    >
